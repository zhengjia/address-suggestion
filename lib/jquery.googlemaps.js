(function($){
    ...
    $.fn.acts_as_address = function(user_defined_options){
        ...
        function load_new_address(longitude, latitude){
        ...
        function add_result_to_page(longitude, latitude){
        ...
        $(".jquery-googlemaps-button").live("click", function(){
            ...
            add_result_to_page(longitude, latitude);
            load_new_address(longitude, latitude);
        });
